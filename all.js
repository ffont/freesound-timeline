...
function playCurrentSounds() {
    ...
    for (i in currentlyPlayedSounds) {
        ...
        var label = '<div id="' + sound_div_id + '"><u>' + snd.name + '</u> by <span class="username">' + snd.username + '</span><span class="play_placeholder" id="' + play_placeholder_id + '">' + play_placeholder_content + '</span></div>';
